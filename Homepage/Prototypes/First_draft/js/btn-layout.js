var menuData = {
	...
	"menu-alert-art":
	{
		...
		right:"currentMenu('menu-alert-hour');currentSlideMenuWithLevels(1);alertChangeTab('hour')",
		up:"",
		down:""
	},
	...
	{
		back:"currentMenu('menu-main');currentMenuSlide(1)",
		left:"hideAllLevelSlides(levelName);currentMenu('menu-alert-hour');currentSlideMenuWithLevels(1);alertChangeTab('hour')",
	...
	"menu-alert-hour":
	{
		...
		up:"changeSlideMenuSlideLevel(left);rotateMango(right)",
		down:"changeSlideMenuSlideLevel(right);rotateMango(left)"
	},
